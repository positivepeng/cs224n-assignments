...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        ...
        self.hidden_to_logit = nn.Linear(self.hidden_size, self.n_classes)
        nn.init.xavier_uniform_(self.hidden_to_logit.weight)
    ...
    def forward(self, t):
        ...
        features = self.embedding_lookup(t)         # batch_size x (n_features * embed_size)
        hidden = self.embed_to_hidden(features)     # batch_size x hidden_size
        relu_out = nn.ReLU()(hidden)                  # batch_size x hidden_size
        drop_out = self.dropout(relu_out)           # batch_size x hidden_size
        logits = self.hidden_to_logit(drop_out)     # batch_size x n_classes
...
#     parse = ParserModel(np.ones((2,3)))
#     print(list(parse.parameters()))
# =============================================================================
